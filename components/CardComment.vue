<template>
  ...
  >
    <div class="text-xs flex text-slate-400 items-center gap-2">
      <svg
      ...
      <div>
        replying to
        <span class="underline">C55H72O5N4Mg</span>
        on item
        <span class="underline">Who the hell are *ThE iNcIdEnTaLs*?</span>
      </div>
    </div>
